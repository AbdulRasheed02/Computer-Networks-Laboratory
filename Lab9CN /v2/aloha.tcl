...
set file1 [open linearTrace.tr w]
$ns trace-all $file1

# Open the nam trace file
set nf [open linearOut.nam w]
$ns namtrace-all $nf
...
proc finish {} {
    ...
    close $nf
    close $file1
    exec nam linearOut.nam &
    exec awk -f throughput.awk linearTrace.tr >> throughputLinear &
    exec awk -f plr.awk linearTrace.tr >> plrLinear &
    exec awk -f overhead.awk linearTrace.tr >> overheadLinear &
    exit 0
}
