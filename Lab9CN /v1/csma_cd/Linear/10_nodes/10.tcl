...
proc finish {} {
    ...
    close $file1
    exec nam out.nam &
    exec awk -f /home/subasri/Acads/Computer_Networks_Lab/lab9/Awkfiles/plr.awk out1.tr > plr_out &
    exec awk -f /home/subasri/Acads/Computer_Networks_Lab/lab9/Awkfiles/overhead.awk out1.tr > overhead_out &
    exec awk -f /home/subasri/Acads/Computer_Networks_Lab/lab9/Awkfiles/throughput.awk out1.tr > throughput_out &
    exit 0
}
...
# Create linear links
for {set i 0} {$i < $num} {incr i} {
    set link($i) [$ns duplex-link $node($i) $node([expr $i+1]) $opt(nc)Mb 0ms DropTail]
}
